    ...
    <div className="px-12 py-8">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex gap-6">
          ...
          <Link href={`/fasyankes/${data.id}/edit`} className="flex items-center gap-1 text-slate-700 font-semibold text-sm hover:cursor-pointer">
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="text-base font-semibold text-slate-900">{data.kode}</div>
        </div>
        <div>
          <div className="text-sm text-slate-400 font-semibold">Jenis Fasyankes</div>
          <div className="text-base font-semibold text-slate-900">{data.jenis}</div>
        </div>
        <div>
          <div className="text-sm text-slate-400 font-semibold">Nomor SIP/STR/Izin Klinik</div>
          <div className="text-base font-semibold text-slate-900">{data.izin}</div>
        </div>
        <div>
          <div className="text-sm text-slate-400 font-semibold">Alamat</div>
          <div className="text-base font-semibold text-slate-900">{data.alamat}</div>
        </div>
        <div>
          <div className="text-sm text-slate-400 font-semibold">Nama Penanggung Jawab</div>
          <div className="text-base font-semibold text-slate-900">{data.penanggungJawab}</div>
        </div>
        <div>
          <div className="text-sm text-slate-400 font-semibold">Email</div>
          <div className="text-base font-semibold text-slate-900">{data.email}</div>
        </div>
      </div>
      ...
      <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/30">
        <ConfirmationPopup
            ...
            message={`Mohon konfirmasi apakah Anda yakin ingin menghapus ${data.nama} dari daftar akun Oculab`}
