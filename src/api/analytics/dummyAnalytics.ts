...
import { SexType } from "@/schemas/enum/SextType";

export async function getTimeAnalyticsListDummy(): Promise<
  ApiResponse<AnalyticsListModel[]>
> {
...
export async function getAnalyticsDetailDummy(): Promise<
  ApiResponse<AnalyticsDetailModel>
> {
  const data: AnalyticsDetailModel = {
    examinationId: "1",
    slideId: "BRN-12345678",
    examinationDate: "27/12/2001",
    totalExaminationAnalysisDuration: "00:10:00",
    expertResultGrading: StatusExaminationType.FINISHED,
    expertResultNotes: "Tidak ditemukan BTA dari 100 gambar lapangan pandang",
    picName: "Dr. Jane Doe",
    ...
    patientDoB: "27/12/2001",
    patientSex: SexType.MALE,
